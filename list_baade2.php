...
$baad_sql="SELECT * FROM `dsr_vinter_baad` where `ID`>0 ORDER BY `dsr_vinter_baad`.`navn` ASC";
$baad_res=mysql_query($baad_sql, $link);

$count_sql="SELECT count( * ) FROM `dsr_vinter_person` WHERE `medlemnr` >0 AND `baad` >0";
